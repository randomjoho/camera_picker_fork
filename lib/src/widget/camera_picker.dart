...
class CameraPicker extends StatefulWidget {
  ...
  /// 是否显示切换摄像头按钮
  final bool showSwitchCameraBtn;
    ...
    final AssetEntity result = await Navigator.of(
      ...
      SlidePageTransitionBuilder<AssetEntity>(
        builder: CameraPicker(
          ...
          switchFrontCamera: switchFrontCamera,
          showSwitchCameraBtn: showSwitchCameraBtn,
        ),
